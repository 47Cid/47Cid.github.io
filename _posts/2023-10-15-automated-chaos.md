...
### Generally, mutations can be categorized into four main groups:
...
### Lexical Mutations
For higher code coverage, it's benifical for the input data to contain certain "interesting" characters or tokens.

[State of the art fuzzers](https://lcamtuf.blogspot.com/2014/11/afl-fuzz-nobody-expects-cdata-sections.html), will analyze comparison operations to extract such interesting constants which enables the fuzzer to generate input data that can explore more branches. 
